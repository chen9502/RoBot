...
public class PermissionUtils {
    ...
    public static void requestPermission(final Activity activity, final int requestCode, PermissionGrant permissionGrant) {
        ...
        //�����6.0���µ��ֻ���ActivityCompat.checkSelfPermission()��ʼ�յ���PERMISSION_GRANTED��
        // ���ǣ�����û��ر����������Ȩ�ޣ�ActivityCompat.checkSelfPermission(),�ᵼ�³������(java.lang.RuntimeException: Unknown exception code: 1 msg null)��
        // �����ʹ��try{}catch(){},�����쳣��Ҳ����������ط�������23��ʲô��������
        // ���˽���try{}catch(){}����������ʾ�û�����Ȩ�ޡ�
